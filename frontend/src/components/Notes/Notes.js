       ...
       <div className="note">
            ...
            <div className="note__body">
                <div className="note__body-head">
                    <input className="note__input" placeholder="Note Title"
                ...
                <div className="note__body-content" >
                    ...
                    <ReactQuill className="note-txt" placeholder="Write Note Here..."
                    value={content} onChange={(e) => contentChange(e)}
                    />

                </div>
                    <div>
                        <button className="another-btn" type="submit">Submit</button>
                    </div>
                    <div>
                        <input className="input-7" placeholder="Add Notebook" value={notebook} onChange={(e) => setNotebook(e.target.value)}/>
                    </div>
            </div>
        </div>
     </form>
